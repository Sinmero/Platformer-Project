...
public class HelenSky : NPC
{
    ...
    public override void Init()
    {
        ...
        var startDialogue = new List<string> {
            "There you are.|Pause(0,5)| Come - have a seat.",
            ...
            "Your dad called me this morning. He told me he'll pick you up in two days, so you better get your things packed and ready.",
            "As long as you're here, take your time to enjoy the stars! You can't see them very well in the city.",
