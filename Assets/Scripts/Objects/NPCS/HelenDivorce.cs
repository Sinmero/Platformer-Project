...
public class HelenDivorce : NPC
{
    ...
    public override void Init()
    {
        ...
        var startDialogue = new List<string> {
            "Whats the matter?|Pause(0,5)| You've been quiet.",
            "I know you are used to a city life but there is plenty of fun stuff to do here too!",
            "I know! We can go to the lake tomorrow. The water... |Pause(1)| ..Oh.",
            "So your parents... |Pause(0,3)|You poor guy.",
            "Do you want to talk about it?|Pause(0,5)| You will feel better if you talk to someone.",
    ...
    public void SecondDialogue(){
        var secondDialogue = new List<string> {
            "{ChangeName(Helen)}Everything is going to be okay, kid."
        };
